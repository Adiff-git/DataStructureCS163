...
private:
    ...
    std::vector<AVLTree> insertTreeStates; // Thêm để lưu trạng thái cây
    ...
    std::vector<AVLTree> deleteTreeStates; // Thêm để lưu trạng thái cây
    ...
    std::vector<AVLTree> searchTreeStates; // Thêm để lưu trạng thái cây
